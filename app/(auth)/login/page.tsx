...
export default function LoginPage() {
  ...
  return (
    <div style={{ 
      ...
      minHeight: '100vh', 
      width: '100vw',
      backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url("fondo.png")', 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '24px' }}>
          <div style={{ width: '100px', height: '115px', marginBottom: '12px', display: 'flex', justifyContent: 'center' }}>
            <svg 
              viewBox="0 0 78 87" 
              style={{ 
                width: '100%', 
        ...
        <form onSubmit={handleLogin} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
          ...
          {/* Campo de Contraseña (Ancho completo alineado) */}
          ...
          {/* Mensaje de error limpio (Solo texto rojo debajo) */}
          {error && (
            <div style={{ width: '100%', marginBottom: '16px' }}>
          ...
          {/* Texto de Invitado a la izquierda */}
